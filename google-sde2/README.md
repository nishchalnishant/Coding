...
If you only follow one thing: do `ROADMAP.md` + `PROBLEM_SET.md` + 6–10 mocks.
...
### System design (often present for L4)
...
1. **Follow the plan:** `ROADMAP.md`
2. **Do the coding set:** `PROBLEM_SET.md`
3. **Use foundations for revision:** `../foundations/GOOGLE_INTERVIEW_REVISION.md`
4. **Use patterns for speed:** `../patterns/README.md`
5. **Graph essentials:** `../foundations/data-structures/graphs.md` (grid BFS/DFS, topo) + `../foundations/algorithms/graph.md` (Dijkstra/MST as needed)
...
- `TEMPLATES.md` — copy/paste templates for coding + system design + mocks
