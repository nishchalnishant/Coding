...
## How to use the rest of this repo (best path)

1. **Pick a timeline:** [ROADMAP.md](ROADMAP.md) (4–6 weeks) or [TWO_WEEK_REVISION.md](TWO_WEEK_REVISION.md) (14 days, includes **2 DSA + AI-ML** variant).
...
4. **Revise by topic:** [../foundations/GOOGLE_INTERVIEW_REVISION.md](../foundations/GOOGLE_INTERVIEW_REVISION.md) + [../foundations/GOOGLE_QUICK_SHEET.md](../foundations/GOOGLE_QUICK_SHEET.md).
5. **Patterns for speed:** [../patterns/README.md](../patterns/README.md).
6. **Graphs:** [../foundations/data-structures/graphs.md](../foundations/data-structures/graphs.md) (grid BFS/DFS, topo) + [../foundations/algorithms/graph.md](../foundations/algorithms/graph.md) (Dijkstra/MST as needed).
7. **Building blocks for design discussions:** [../advanced-dsa/system-design-algorithms.md](../advanced-dsa/system-design-algorithms.md) (optional depth).
