...
|-------|----------------|----------------|------------------|
| Arrays, prefix sums, hashing | Two pointers, prefix + map, frequency | [../foundations/data-structures/array.md](../foundations/data-structures/array.md), [../foundations/data-structures/hashing.md](../foundations/data-structures/hashing.md) | [PROBLEM_SET.md](PROBLEM_SET.md) — arrays, hashing |
| Two pointers + sliding window | Variable/fixed window, invariants | [../patterns/two-pointers-sliding-window.md](../patterns/two-pointers-sliding-window.md) | [PROBLEM_SET.md](PROBLEM_SET.md) — two pointers, sliding window |
...
|-------|----------------|----------|
| **DP** (1D/2D, LIS/LCS, knapsack/coin) | [../foundations/algorithms/dynamic-programming/README.md](../foundations/algorithms/dynamic-programming/README.md), [../patterns/dp-advanced.md](../patterns/dp-advanced.md) | [PROBLEM_SET.md](PROBLEM_SET.md) — DP |
...
| **Bit manipulation** | [../foundations/algorithms/bit-manipulation.md](../foundations/algorithms/bit-manipulation.md) | Optional: [../30-day/week-3/day-18-bit-manipulation-techniques..md](../30-day/week-3/day-18-bit-manipulation-techniques..md) |
...
| **One-page pattern recall** | [../foundations/GOOGLE_QUICK_SHEET.md](../foundations/GOOGLE_QUICK_SHEET.md) |
| **Full foundations revision (Parts A–D)** | [../foundations/GOOGLE_INTERVIEW_REVISION.md](../foundations/GOOGLE_INTERVIEW_REVISION.md) |
| **Topic ↔ canonical problems index** | [../foundations/TOPIC_QUESTIONS_LOGIC_AND_TRICKS.md](../foundations/TOPIC_QUESTIONS_LOGIC_AND_TRICKS.md) |
...
The [../30-day/README.md](../30-day/README.md) program aligns by theme: week 1 (DS basics), week 2 (BST, heaps, graphs, DP intro), week 3 (backtracking, greedy, bit, mocks), week 4 (problem-solving, Google-focused day, final mocks, relaxation). For **Google-tagged review**, see [../30-day/week-4/ay-24-focus-on-google-specific-questions.md](../30-day/week-4/ay-24-focus-on-google-specific-questions.md).
...
| Day | Focus | Actions |
|-----|--------|---------|
| **1** | Setup + arrays / hashing + windows | Skim [CODING_ROUNDS.md](CODING_ROUNDS.md); [GOOGLE_INTERVIEW_REVISION.md](../foundations/GOOGLE_INTERVIEW_REVISION.md) Part A + B1–B2; solve **3–4** from [PROBLEM_SET.md](PROBLEM_SET.md) (arrays, two pointers, window). Confirm **EET time** in your local time + **interview order** (which day is EET vs on-site). |
| **2** | Arrays + strings (speed) | [two-pointers-sliding-window.md](../patterns/two-pointers-sliding-window.md); **3–4** problems; log mistakes in [PRACTICE_TRACKER.md](PRACTICE_TRACKER.md). |
| **3** | Trees + BST | [tree.md](../foundations/data-structures/tree.md); **3–4** tree problems; verbalize traversals and LCA cases. |
| **4** | Binary search + heap + **AI-ML (first pass)** | [searching.md](../foundations/algorithms/searching.md), [heap.md](../foundations/data-structures/heap.md); **3** problems. **~90 min:** skim the **AI / ML revision checklist** above; write **3** bullet “definitions you could say in 60s” (e.g. train/val, precision/recall, overfitting). |
| **5** | Stack / queue, linked lists | [stack.md](../foundations/data-structures/stack.md); monotonic / parentheses; **2–3** problems; **1** list problem. |
| **6** | **Mock #1 (video / EET-style)** + graphs | **Timed DSA mock** in **45–60 min** with **camera + screen share** (1–2 problems) — this is your **EET** rehearsal. Then BFS/DFS: [graph.md](../foundations/algorithms/graph.md), [graphs.md](../foundations/data-structures/graphs.md); **2** graph/grid problems. |
| **7** | AI-ML + week review + optional SD | **2 h:** one **STAR** ML story + one **open-ended** ML question out loud (see AI / ML section). Re-read [GOOGLE_QUICK_SHEET.md](../foundations/GOOGLE_QUICK_SHEET.md). Re-do **1** failed problem cold. *Only if* a **general** SD round is on your schedule: **1** pass [SYSTEM_DESIGN_L4.md](SYSTEM_DESIGN_L4.md) (else skip). |

**Week 1 goal:** you can name the **pattern in 30–60 seconds** (see [GOOGLE_INTERVIEW_REVISION.md](../foundations/GOOGLE_INTERVIEW_REVISION.md)); you have done **at least one** DSA session under **virtual** conditions.
...
| **9** | DP core | [dynamic-programming/README.md](../foundations/algorithms/dynamic-programming/README.md) + [dp-advanced.md](../patterns/dp-advanced.md) skim; **3–4** DP problems (1D, 2D, one LIS/LCS-style). |
| **10** | Backtracking + greedy + **AI-ML (production + metrics)** | [backtracking.md](../foundations/algorithms/backtracking.md), [greedy.md](../foundations/algorithms/greedy.md); **2–3** problems. **~2 h:** train/serve skew, monitoring, one **ML system design** outline (15 min talk) from the AI / ML section. |
...
| **14** | Light revision + rest | [GOOGLE_INTERVIEW_REVISION.md](../foundations/GOOGLE_INTERVIEW_REVISION.md) Part A + [GOOGLE_QUICK_SHEET.md](../foundations/GOOGLE_QUICK_SHEET.md) only. **0** new topics. Optional: [../30-day/week-4/day-28-relaxation-techniques-before-interviews.md](../30-day/week-4/day-28-relaxation-techniques-before-interviews.md). **Logistics:** charge laptop, test **EET** link, **ID / badge** for on-site, sleep. Prepare **2–3** questions for interviewers (team + **ML/infra** if relevant). |
...
Use the **7-day table** in [GOOGLE_INTERVIEW_REVISION.md](../foundations/GOOGLE_INTERVIEW_REVISION.md) (Part D) and add: **2 DSA mocks** (one **video / EET-style**, one **in-person or paper**), **1** focused **AI-ML** block (see checklist), **3** behavioral/STAR stories, and **0–1** general SD passes **only** if a separate system-design round is confirmed.

---

## If you have 48 hours left

Follow **Part D — If you have 48 hours** in [GOOGLE_INTERVIEW_REVISION.md](../foundations/GOOGLE_INTERVIEW_REVISION.md), plus [GOOGLE_QUICK_SHEET.md](../foundations/GOOGLE_QUICK_SHEET.md) and [CODING_ROUNDS.md](CODING_ROUNDS.md). **Skim** the **AI / ML** checklist once; **do not** start new ML theory. Re-run a **45 min EET-style** block (audio + screen share) if the **virtual** DSA is still ahead of you.

---

## Related repo index (optional depth)

- **Longer DSA roadmap (SDE-3 style, still useful for problem order):** [../SDE3_DSA_ROADMAP.md](../SDE3_DSA_ROADMAP.md)  
- **Top 20–style curated list:** [../sde-3-guide/sde-3-guide.md](../sde-3-guide/sde-3-guide.md)  
- **LeetCode pattern list:** [../patterns/leetcode-patterns.md](../patterns/leetcode-patterns.md)  
- **System design + algorithms (advanced):** [../advanced-dsa/system-design-algorithms.md](../advanced-dsa/system-design-algorithms.md) (useful for large-scale and **data/ML-style** system discussions)  
- **Repository audit / orientation:** [../GOOGLE_SDE2_AUDIT.md](../GOOGLE_SDE2_AUDIT.md), [../README.md](../README.md)  
