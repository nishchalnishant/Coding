...
* ## **Two pointers**
  ...
  *   **Explanation:**
      ...
      1. Initialise two pointers, one at the start (`left`) and one at the end (`right`) of the array.
...
* ## **Fast and slow pointers**
  ...
  *   **Explanation:**
      ...
      1. Initialise two pointers, one moving one step at a time (**slow**) and the other moving two steps at a time (**fast**).
...
* ## <mark style="color:$danger;">Monotonic stack</mark>
...
* ## <mark style="color:$danger;">Overlapping intervals</mark>
