...
For explanations and practice lists, use the topic files under [data-structures/](../../tracks/foundations/data-structures/) and [algorithms/](../../tracks/foundations/algorithms/). Each topic file has an **Interview Questions — Logic & Trickiness** section; consolidated tables: [canonical-questions.md](../problem-bank/canonical-questions.md). **Google SDE-2** full track (problem set, mocks): [google-sde2/README.md](../../tracks/google-sde2/README.md).
