...
**Deep dive — questions, logic, trickiness:** [Canonical Problem Bank](../../reference/problem-bank/canonical-questions.md) (canonical problems by topic with solution logic and gotchas).
...
- [Tries & Segment Trees](trie-segment-trees.md)
...
- [SDE-3 Roadmap](roadmap.mdSDE3_DSA_ROADMAP.md) — practice order  
- [Revision Guide](../../reference/quick-sheets/revision-guide.md) — focused revision  
