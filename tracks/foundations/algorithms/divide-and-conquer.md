...
| **[Problem Details](../../google-sde2/PROBLEM_DETAILS.md#majority-element)** | **Boyer–Moore:** candidate + count; cancel pairs; second pass **verify** count > n/2. | Works only if **strict majority** > ⌊n/2⌋; **D&C:** majority of whole is majority of a half or doesn’t exist—then verify. |
...
| **[Problem Details](../../google-sde2/PROBLEM_DETAILS.md#median-of-two-sorted-arrays)** | See binary search partition in [searching](searching.md)—often classified as D&C + BS. | **O(log(min(m,n)))** goal. |
