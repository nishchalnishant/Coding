...
Notes on the **choice diagram** and **0/1 knapsack** way of building DP. For the main SDE-3 DP guide see [Patterns Master](../../../../reference/patterns/patterns-master.md).
...
- **Question variations:**
  ...
  - [Problem Details](../../../google-sde2/PROBLEM_DETAILS.md#edit-distance) — similar grid; insert/delete/replace costs.
...
- **Idea:** Optimal solution on `[Problem Details](../../../google-sde2/PROBLEM_DETAILS.md#burst-balloons)** and **palindrome partitioning II** use the same **interval** state.
...
- **Question variations:**
  ...
  - [Problem Details](../../../google-sde2/PROBLEM_DETAILS.md#burst-balloons) — add imaginary 1 at ends; value at `k` when last to burst in `(i,j)`.
...
- **Question variations:**
  ...
  - [Problem Details](../../../google-sde2/PROBLEM_DETAILS.md#cheapest-flights-within-k-stops) — state `(city, edges_used)` or Bellman-Ford `K` rounds.
  - **Travelling salesman** (bitmask), **collect all keys** (state = position + key mask).
  - **Follow-up:** **0-1 BFS** / **[Problem Details](../../../google-sde2/PROBLEM_DETAILS.md#dijkstra)** when weights non-negative — not always labeled “DP” but same “relax in order” idea.
