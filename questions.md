...
- [ ] [Longest Consecutive `🎯 T2`](coding/data-structures/02-hashing.md#longest-consecutive-sequence) — Solve the standard interview variant of Longest Consecutive. [H]
...
- [ ] [Minimum Window `⚡ T1`](coding/data-structures/03-string.md#minimum-window-substring) — Solve the standard interview variant of Minimum Window. [H]
...
- [ ] [LCA BST `⚡ T1`](01-data-structures/08-tree.md#lowest-common-ancestor-lca) — Solve the standard interview variant of LCA BST. [M]
...
- [ ] [Jump Game I `🎯 T2`](coding/algorithms/16-greedy.md#jump-game-can-reach) — Determine whether the end of the array is reachable. [M]
- [ ] [Jump Game II `🎯 T2`](coding/algorithms/16-greedy.md#jump-game-ii-minimum-jumps) — Given an array where `nums[i]` is the max jump from index `i`, return the minimum number of jumps to reach the last index. Always reachable [M]
...
- [ ] [Time Based Key-Value Store `🎯 T2`](coding/algorithms/11-binary-search.md#time-based-key-value-store-lc-981) — Solve the standard interview variant of Time Based Key-Value Store. [M]
- [ ] [Koko Eating Bananas `⚡ T1`](coding/algorithms/11-binary-search.md#koko-eating-bananas-lc-875) — `piles` of bananas. Eat at constant speed `k` bananas/hour, one pile at a time. Must finish all piles in `h` hours. Minimize `k` [M]
...
- [ ] [Group Anagrams `🎯 T2`](coding/data-structures/03-string.md#group-anagrams) — Group strings that are anagrams of each other [M]
- [ ] [Valid Parenthesis String `🎯 T2`](coding/data-structures/05-stack.md#valid-parenthesis-string-lc-678) — Solve the standard interview variant of Valid Parenthesis String. [M]
...
- [ ] [Best Time to Buy and Sell Stock II `⚡ T1`](coding/algorithms/15-dynamic-programming.md#best-time-to-buy-and-sell-stock-all-variants) — Solve the standard interview variant of Best Time to Buy and Sell Stock II. [M]
